<?php
require_once 'tinymce/plugins.php';
...
if ( ! function_exists( 'vwsce_admin_enqueue_scripts' ) ) {
	function vwsce_admin_enqueue_scripts() {
		wp_enqueue_script( 'shortcode-editor', get_template_directory_uri().'/framework/shortcode-editor/js/shortcode-editor.js', array( 'jquery' ), null, true );
