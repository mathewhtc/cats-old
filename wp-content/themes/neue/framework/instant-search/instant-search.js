;(function( $, window, document, undefined ){
	...
	var INSTANT_SEARCH = {
		...
		delay_search: null,
		keywords: '',
		form_template: '<form class="vw-instant-search-panel" method="get" autocomplete="off"> <input type="text" id="s" name="s" value="" placeholder="Search"> <i class="loading-icon icon-symbol-spin3 animate-spin hidden"></i> <ul class="vw-instant-search-result-panel"></ul> </form>',
		defaults: {
			search_delay: 350,
		},
