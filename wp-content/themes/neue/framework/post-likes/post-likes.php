...
defined( 'VW_CONST_POST_LIKES_URL' ) || define( 'VW_CONST_POST_LIKES_URL', get_template_directory_uri().'/framework/post-likes' );
...
if ( ! function_exists( 'vw_the_likes' ) ) {
	function vw_the_likes() {
		...
		printf( '<a href="#" class="vw-post-likes %2$s" id="vw-post-likes-id-%1$s" data-post-id="%1$s" title="%3$s">', $post->ID, $classes, __( 'I like this', 'envirra' ) );
