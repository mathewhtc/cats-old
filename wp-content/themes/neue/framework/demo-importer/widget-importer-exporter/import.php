...
function wie_import_data( $data ) {
	...
	foreach ( $data as $sidebar_id => $widgets ) {
		...
		foreach ( $widgets as $widget_instance_id => $widget ) {
			...
			$results[$sidebar_id]['widgets'][$widget_instance_id]['title'] = isset( $widget->title ) && $widget->title ? $widget->title : __( 'No Title', 'widget-importer-exporter' ); // show "No Title" if widget instance is untitled
